...
# .build/apple/Products/Release this script assumed until 4.0.11. Evaluated
# inside BUILD_TREE (same arch flags as the build above) so the isolated
# checkout's own bin path is used, not the primary tree's.
